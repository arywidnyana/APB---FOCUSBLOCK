...
// TANGGUNG JAWAB: Layar full-screen focus timer Pomodoro.
//   Menampilkan countdown, fase, kontrol pause/selesai/lewati.
// =============================================================
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(widget.block.subject, style: AppTypography.h4),
        centerTitle: true,
      ),
