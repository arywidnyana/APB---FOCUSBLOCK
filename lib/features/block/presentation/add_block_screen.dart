...
//   Validasi input dan simpan ke database via BlockProvider.
// =============================================================
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (!_customSubject)
                    ...
                    _buildCustomSubjectField(),
                  const SizedBox(height: 4),
                  GestureDetector(
                    onTap: () => setState(() => _customSubject = !_customSubject),
                    child: Text(
                      _customSubject
                          ? '← Pilih dari daftar'
                          ...
                          children: [
                            ...
                            _TimePickerField(
                              ...
                              onChanged: (t) => setState(() =>
                                _startTime = DateTime(
                                  _startTime.year, _startTime.month,
                                  _startTime.day, t.hour, t.minute)),
                            ),
                          ],
                        ),
                      ),
                  ...
                  // Preview blok
                  _BlockPreview(
                    subject:  _customSubject
                        ? _customSubjectCtrl.text.isEmpty
                            ? 'Mata kuliah'
                            : _customSubjectCtrl.text
                        : _subject,
                    session:  _sessionCtrl.text.isEmpty
                        ? 'Nama sesi'
                        : _sessionCtrl.text,
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    '${fmt(startTime)} — ${fmt(end)} · $duration menit · $session',
